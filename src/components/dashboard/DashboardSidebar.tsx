...
const navMid = [
  { title: "Trading Plans", icon: Clock, href: "/main/accounts" },
  { title: "Fund Protection", icon: ShieldCheck, href: "/main/verification" },
  { title: "Fund Managers", icon: Users, href: "/main/kyc-partners" },
