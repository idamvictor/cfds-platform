  ...
  return (
    <section className="mb-6">
      <div className="mb-4 flex items-center gap-2.5">
        ...
        >
          <ListChecks className="h-[0.88rem] w-[0.88rem]" />
        </div>
      ...
      >
        <div className="mb-4 flex items-center justify-between gap-3">
          <div>
            ...
            <div className="mt-1 text-[0.78rem] text-[#4a5468]">
              Restrict withdrawals to a list of approved addresses.
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="rounded-[12px] border border-[rgba(255,255,255,0.04)] bg-[rgba(0,0,0,0.2)] p-8">
          <div className="flex flex-col items-center justify-center gap-2 text-center">
            ...
            <div className="max-w-[320px] text-[0.75rem] text-[#4a5468]">
              When this feature becomes available, your approved withdrawal
