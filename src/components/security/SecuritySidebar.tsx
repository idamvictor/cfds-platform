...
export function SecuritySidebar({ isOpen = false, onClose }: SecuritySidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-16 bottom-0 z-[250] w-[260px] flex-col gap-1 overflow-y-auto border-r border-[rgba(255,255,255,0.06)] p-4 backdrop-blur-[40px] transition-transform duration-200 lg:static lg:top-0 lg:flex lg:translate-x-0 ${
