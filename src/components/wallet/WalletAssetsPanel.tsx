...
export function WalletAssetsPanel() {
  return (
    <div
      className="relative overflow-hidden rounded-2xl border-[1.5px] border-[rgba(255,255,255,0.08)] p-7 shadow-[0_8px_32px_rgba(0,0,0,0.4),0_2px_8px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.06)]"
      style={{
        background:
      ...
      <div className="relative">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              <tr>
                {["Asset", "Balance", "Value (USD)", "Price", "24h Change", "Allocation"].map(
                  (h) => (
                    <th
                      key={h}
              ...
              <tr>
                <td colSpan={6} className="px-4 py-16">
                  <div className="flex flex-col items-center justify-center gap-3 text-center">
                    ...
                    <div className="max-w-[360px] text-[0.78rem] text-[#4a5468]">
