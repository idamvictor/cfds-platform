    ...
    <div className="relative flex items-center w-fit">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            className={`bg-[#10B981] hover:bg-[#059669] text-white pr-10 py-1.5 h-auto shadow-none font-semibold text-base w-[120px] rounded-tl-sm rounded-bl-sm rounded-tr-none rounded-br-none ${
              isAutoTraderLocked
          ...
          >
            <span className="flex flex-col items-start gap-0 w-full">
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-.5 rounded-sm z-10 bg-black text-white flex items-center justify-center px-2 py-.5"
            >
              <p className="text-[11px] tabular-nums">{activeAsset?.spread ?? 0}</p>
            </div>
          </TooltipTrigger>
          <TooltipContent
            className={`${
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            className={`bg-[#FF4D4D] hover:bg-[#e63939] text-white pl-10 py-1.5 h-auto shadow-none font-semibold text-base w-[120px] rounded-tr-sm rounded-br-sm rounded-tl-none rounded-bl-none ${
              isAutoTraderLocked
            ...
            onPointerDown={handleTriggerPointerDown}
          >
            <span className="flex flex-col items-end gap-0 w-full">
