...
import { FileText, User, ArrowLeft, ArrowRight, CheckCircle } from "lucide-react";
...
export default function VerificationPage() {
  ...
  const handleEditDocument = (type: string) => {
    if (isVerified) {
      toast.error("Your account is already verified. Document editing is disabled.");
      return;
    }
    setEditingType(type);
  };
      ...
      <div className="container mx-auto p-8">
        ...
        {isVerified && (
            <Alert className="mb-6 bg-primary/10 border-primary/30">
              ...
              <AlertDescription>
                Your account is fully verified. All trading features are now available.
              </AlertDescription>
            </Alert>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <DocumentUploader
              ...
              disabled={(isDocumentUploaded("selfie") && editingType !== "selfie") || isVerified}
          />
          ...
          <DocumentUploader
              ...
              disabled={
                  (isDocumentUploaded("proof_of_address") &&
                      editingType !== "proof_of_address") || isVerified
              }
          />
          ...
          <DocumentUploader
              ...
              onUpload={handleUpload}
              disabled={
                  (isDocumentUploaded("proof_of_id") && editingType !== "proof_of_id") || isVerified
              }
          />
          ...
          <DocumentUploader
              ...
              disabled={
                  (isDocumentUploaded("proof_of_id_back") &&
                      editingType !== "proof_of_id_back") || isVerified
              }
          />
        </div>
        ...
        <div className="mb-8">
          <div className="flex justify-between mb-2">
            ...
            {isVerified ? "4 of 4 (Complete)" :
                `${documents.length +
                (documents.find((d) => d.type === "id") ? 1 : 0)} of 4`}
          </span>
          </div>
        ...
        <Card className="p-4">
          {isVerified ? (
              <p className="text-sm text-primary">
                Your account is fully verified. You can view your submitted documents above but can no longer modify them.
              </p>
          ) : (
