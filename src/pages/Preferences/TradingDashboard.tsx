  ...
  const news = [
    {
      ...
      time: "9 hours ago",
      title:
        'SPX: S&P 500 Futures Steady After Trump Urges Everyone to "Buy Stocks Now"',
      icon: "🔴",
    },
    {
      source: "Bitcoin",
        ...
        <div className="p-8 flex flex-col px-10 md:flex-row justify-between items-center">
          ...
          <div className="md:w-80 mt-6 md:mt-0">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white self-start mb-4">
                Account
              </h3>
