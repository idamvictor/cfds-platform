...
export default function ICMarketLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#181A20] text-white flex flex-col">
      ...
      {settings?.login_page_footer ? (
        ...
        <div className="mt-8 hidden md:block bg-[#1E2329] py-4">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <div className="text-center text-xs text-white/40">
              <p>
                Risk warning: Trading Derivatives carries a high level of risk
                to your capital and you should only trade with money you can
                afford to lose. Trading Derivatives may not be suitable for all
                investors, so please ensure that you fully understand the risks
                involved and seek independent advice if necessary. Raw Spread
                accounts offer spreads from 0.0 pips with a commission charge of
                USD $3.50 per 100k traded. Standard account offers spreads from
                0.8 pips with no additional commission charges. Spreads on CFD
      ...
      {settings?.login_page_footer ? (
        <div className="mt-4 px-4 pb-4 text-center text-xs text-white/40 md:hidden">
          <p>{settings?.login_page_footer}</p>
        </div>
      ) : (
        <div className="mt-4 px-4 pb-4 text-center text-xs text-white/40 md:hidden">
          <p>
            ...
            from 0.0 pips with a commission charge of USD $3.50 per 100k traded.
            Standard account offers spreads from 0.8 pips with no additional
            commission charges. Spreads on CFD indices start at 0.4 points.
          </p>
        </div>
      )}
    </div>
