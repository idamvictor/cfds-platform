...
export default function LoginBasic() {
  ...
  // ── OTP screen (UNCHANGED render condition) ──
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#07080c] text-[#eef2f7]">
      ...
      <div className="flex flex-1 items-center justify-center px-5 py-10 md:py-16">
        <div className="grid w-full max-w-[880px] grid-cols-1 items-center gap-10 md:grid-cols-2">
          ...
          <div className="order-2 flex flex-col md:order-1">
            ...
            <div className="auth-glass-card relative overflow-hidden rounded-3xl border-[1.5px] border-white/[0.08] bg-gradient-to-br from-white/[0.06] via-white/[0.02] to-[#00dfa2]/[0.02] p-7 shadow-[0_4px_24px_rgba(0,0,0,0.4),0_20px_60px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.06)] backdrop-blur-xl sm:p-9">
              ...
              <div className="relative z-[2] mb-7 flex items-center justify-between border-b border-white/[0.06] pb-5">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-full border border-[#00dfa2]/25 bg-gradient-to-br from-[#00dfa2]/[0.12] to-[#00b881]/[0.08] px-4 py-1.5 text-[0.78rem] font-semibold text-[#00dfa2] shadow-[0_2px_8px_rgba(0,223,162,0.1)]">
              ...
              <Form {...form}>
                ...
                >
                        ...
                        <div className="relative">
                          <FormControl>
                            <Input
                              ...
                              placeholder="••••••••"
                              {...field}
                              className="h-12 rounded-[14px] border-[1.5px] border-white/[0.1] bg-gradient-to-br from-white/[0.06] to-white/[0.02] px-[18px] pr-12 text-[0.95rem] text-[#eef2f7] placeholder:text-[#4a5468] transition-all hover:border-white/[0.18] focus-visible:border-[#00dfa2] focus-visible:shadow-[0_0_0_3px_rgba(0,223,162,0.1)] focus-visible:ring-0 focus-visible:ring-offset-0"
                            />
                          </FormControl>
                          <button
                            type="button"
                  ...
                  <div className="-mt-2 text-right">
                    <Link
                      to="/forgot-password"
                      className="text-[0.85rem] font-semibold text-[#00dfa2] transition-colors hover:text-[#00ffc3]"
                    >
                      Forgot password?
                    </Link>
                  </div>
              ...
              <div className="relative z-[2] grid grid-cols-3 gap-2.5">
                <button
                  type="button"
                  disabled
                  className="flex h-11 cursor-not-allowed items-center justify-center rounded-[14px] border-[1.5px] border-white/[0.1] bg-gradient-to-br from-white/[0.06] to-white/[0.02] text-[#eef2f7] opacity-60 transition-all"
                  title="Apple login"
                >
                ...
                <button
                  type="button"
                  disabled
                  className="flex h-11 cursor-not-allowed items-center justify-center rounded-[14px] border-[1.5px] border-white/[0.1] bg-gradient-to-br from-white/[0.06] to-white/[0.02] opacity-60 transition-all"
                  title="Google login"
                >
      ...
      {/* ── Footer ── */}
      <footer className="border-t border-white/[0.06] bg-gradient-to-b from-[#0a0d14] to-[#07080c] px-5 py-6">
        <div className="mx-auto flex max-w-[880px] flex-col items-center gap-4 sm:flex-row sm:justify-between">
          <div className="flex flex-wrap justify-center gap-3">
            <ComplianceBadge color="#00dfa2" label="SOC 2 Type II" />
            <ComplianceBadge color="#f5a623" label="256-bit SSL" />
            <ComplianceBadge color="#00dfa2" label="KYC / AML" />
            <ComplianceBadge color="#5b8def" label="Cold Storage" />
            <ComplianceBadge color="#f43f5e" label="2FA Protected" />
          </div>
...
function ComplianceBadge({
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-white/[0.08] bg-white/[0.03] px-3 py-1 text-[0.78rem] text-[#8b97a8]">
